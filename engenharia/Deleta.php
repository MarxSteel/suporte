   ...
   <div class="container">
    <section class="content">
     ...
     <h3>DESEJA REALMENTE EXCLUIR ?</h3>  
      <form name="deleta" id="name" method="post" action="" enctype="multipart/form-data">
       <div class="col-xs-12"><br />
        <input name="deleta" type="submit" class="btn bg-orange btn-lg btn-block" value="SIM, EXCLUIR"  />
       </div>
      </form>
       <?php 
        if(@$_POST["deleta"])
        {
         $Deleta = $PDO->query("DELETE FROM produto WHERE nome='$UsuarioCod'");
         if ($Deleta) 
         {
          $DataLog = date('Y-m-d - H:i:s');
          $Loog = "Modelo de Equipamento Deletado";
          $InsereLog = $PDO->query("INSERT INTO log (Cod, TipoLog, DataCadastro, UserCadastro, Descreve) VALUES ('144', '$Loog', '$DataLog', '$NomeUserLogado', '$Obs')");
          if ($InsereLog) 
          {
